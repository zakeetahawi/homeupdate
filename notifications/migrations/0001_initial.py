    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "message",
                    models.TextField(
                        help_text="نص تفصيلي للإشعار", verbose_name="الرسالة"
                    ),
                ),
                (
                    "notification_type",
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default=dict,
                        help_text="بيانات إضافية للإشعار في صيغة JSON",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=True, verbose_name="إشعارات العملاء"),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(default=True, verbose_name="إشعارات المعاينات"),
                ),
                (
                    "enable_installation_notifications",
                    models.BooleanField(default=True, verbose_name="إشعارات التركيبات"),
                ),
                (
                    "enable_complaint_notifications",
                    models.BooleanField(default=True, verbose_name="إشعارات الشكاوى"),
                ),
                (
                    "min_priority_level",
                    models.CharField(
                        ...
                        default="low",
                        help_text="لن يتم عرض الإشعارات أقل من هذا المستوى",
                        max_length=10,
                        verbose_name="الحد الأدنى لمستوى الأولوية",
                    ),
                ),
                (
                    "created_at",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="notifications.NotificationVisibility",
                to=settings.AUTH_USER_MODEL,
                verbose_name="مرئي لـ",
            ),
        ),
        migrations.AddIndex(
            model_name="notificationvisibility",
            index=models.Index(
                fields=["user", "is_read"], name="notificatio_user_id_385ae4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notificationvisibility",
            index=models.Index(
                fields=["notification", "user"], name="notificatio_notific_c1b0f9_idx"
            ),
        ),
