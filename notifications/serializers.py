...
class NotificationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'priority', 'priority_display', 'icon_class', 'color_class',
            'created_by', 'created_at', 'extra_data', 'absolute_url',
            'is_read', 'read_at', 'related_object_info'
        ]
        ...
        if obj.related_object:
            try:
                return {
                    ...
                    'url': obj.related_object.get_absolute_url() if hasattr(obj.related_object, 'get_absolute_url') else None
                }
            except:
                return {
...
class NotificationSettingsSerializer(serializers.ModelSerializer):
    ...
    user = UserSerializer(read_only=True)
    min_priority_level_display = serializers.CharField(source='get_min_priority_level_display', read_only=True)
    
    class Meta:
        model = NotificationSettings
        fields = [
            'user', 'enable_customer_notifications', 'enable_order_notifications',
            'enable_inspection_notifications', 'enable_installation_notifications',
            'enable_complaint_notifications', 'min_priority_level', 'min_priority_level_display',
...
class NotificationCreateSerializer(serializers.Serializer):
    ...
    priority = serializers.ChoiceField(choices=Notification.PRIORITY_LEVELS, default='normal')
