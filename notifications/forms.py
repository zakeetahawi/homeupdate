...
class NotificationSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "notifications_enabled": forms.CheckboxInput(
                attrs={"class": "form-check-input", "id": "notifications_enabled"}
            ),
            "customer_created_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "customer_created",
                }
            ),
            "order_created_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "order_created",
                }
            ),
            "order_updated_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "order_updated",
                }
            ),
            "order_status_changed_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "order_status_changed",
                }
            ),
            "order_delivered_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "order_delivered",
                }
            ),
            "installation_scheduled_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "installation_scheduled",
                }
            ),
            "installation_completed_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "installation_completed",
                }
            ),
            "inspection_created_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "inspection_created",
                }
            ),
            "inspection_status_changed_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "inspection_status_changed",
                }
            ),
            "manufacturing_status_changed_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "manufacturing_status_changed",
                }
            ),
            "complaint_created_enabled": forms.CheckboxInput(
                attrs={
                    "class": "form-check-input notification-type-checkbox",
                    "data-type": "complaint_created",
                }
            ),
            "min_priority_level": forms.Select(attrs={"class": "form-select"}),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["notifications_enabled"].help_text = _(
            "إلغاء تحديد هذا الخيار سيوقف جميع الإشعارات"
        )
...
class BulkNotificationSettingsForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super().__init__(*args, **kwargs)
        self.fields["users"].queryset = User.objects.filter(is_active=True).order_by(
...
class NotificationFilterForm(forms.Form):
    ...
    is_read = forms.ChoiceField(
        choices=[("", _("الكل")), ("true", _("مقروء")), ("false", _("غير مقروء"))],
        required=False,
        widget=forms.Select(attrs={"class": "form-select"}),
