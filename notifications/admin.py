...
class NotificationAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'title', 'notification_type_display', 'priority_display',
        'created_by_display', 'recipients_count', 'unread_count',
        'created_at_display', 'related_object_link'
    ]
    ...
    readonly_fields = [
        ...
        'related_object_link', 'recipients_count', 'unread_count'
    ]
    ...
    fieldsets = (
        ...
        (_('إحصائيات'), {
            'fields': ('recipients_count', 'unread_count'),
            'classes': ('collapse',)
        }),
    )
...
class NotificationVisibilityAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'notification_title', 'user_display', 'is_read_display',
        'read_at_display', 'created_at_display'
    ]
...
class NotificationSettingsAdmin(admin.ModelAdmin):
    ...
    list_display = [
        'user_display', 'enable_customer_notifications',
        'enable_order_notifications', 'enable_inspection_notifications',
        'enable_installation_notifications', 'enable_complaint_notifications',
        'min_priority_level'
    ]

    list_filter = [
        'enable_customer_notifications', 'enable_order_notifications',
        'enable_inspection_notifications', 'enable_installation_notifications',
        'enable_complaint_notifications', 'min_priority_level'
    ]
