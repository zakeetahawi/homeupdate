        ...
        for order in target_orders.order_by('order_number'):
            ...
            for inspection in inspections:
                ...
                possible_order_date_fields = [
                    'order_date', 'order_request_date', 'request_date', 
                    'main_order_date', 'parent_order_date'
                ]
                ...
                if hasattr(inspection, 'inspection_date'):
                    print(f"      📋 تاريخ المع��ينة الحالي: {inspection.inspection_date}")
                ...
                if order.order_date:
                    ...
                    for field_name in possible_order_date_fields:
                        if hasattr(inspection, field_name):
                            ...
                            print(f"      ✅ تحديث {field_name}: {old_value} → {new_value}")
