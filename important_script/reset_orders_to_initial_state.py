...
def main():
    ...
    with transaction.atomic():
        ...
        manufacturing_orders_to_reset = ManufacturingOrder.objects.filter(order__in=target_orders)
        ...
        installations_to_reset = InstallationSchedule.objects.filter(order__in=target_orders)
