...
class InstallationStatusForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "status": forms.Select(
                attrs={"class": "form-control", "id": "installation-status"}
            ),
        ...
        if self.instance and self.instance.pk:
            if new_status != self.instance.status:
                ...
                if new_status in ["cancelled", "modification_required"] and not reason:
                    raise forms.ValidationError(
                        "سبب التغيير مطلوب لهذا النوع من التغيير"
                    )
...
class ModificationRequestForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "modification_type": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "نوع التعديل المطلوب"}
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "description": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "وصف الصورة"}
            ),
        }
...
class CustomerDebtForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "payment_receipt_number": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "رقم إذن استلام المبلغ"}
            ),
            "payment_receiver_name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "اسم المستلم"}
            ),
        }
...
class CustomerDebtPaymentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "payment_receipt_number": forms.TextInput(
                attrs={"placeholder": "رقم إذن استلام المبلغ"}
            ),
            "payment_receiver_name": forms.TextInput(
                attrs={"placeholder": "اسم المستلم"}
            ),
            "notes": forms.Textarea(
                attrs={"rows": 3, "placeholder": "ملاحظات الدفع..."}
            ),
        }
...
class InstallationScheduleForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "notes": forms.Textarea(
                attrs={"rows": 3, "placeholder": "أضف ملاحظات هنا..."}
            ),
        }
...
class QuickScheduleForm(forms.ModelForm):
    ...
    update_customer_address = forms.CharField(
        ...
        help_text=_(
            "إذا تم ملء هذا الحقل، سيتم تحديث العنوان الرئيسي للعميل في جميع أنحاء النظام"
        ),
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        if order and order.customer:
            ...
            if customer_location_type:
                location_type_display = dict(
                    order.customer._meta.get_field("location_type").choices
                ).get(customer_location_type, "")
    ...
    class Meta:
        ...
        widgets = {
            ...
            "location_address": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
...
class InstallationTeamForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"placeholder": "اسم الفريق", "class": "form-control"}
            ),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["technicians"].queryset = Technician.objects.filter(
            department="installation", is_active=True
        )
...
class TechnicianForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            "specialization",
            "is_active",
        ]  # إزالة department من الحقول المعروضة
        widgets = {
            "name": forms.TextInput(
                attrs={"placeholder": "اسم الفني", "class": "form-control"}
            ),
            "phone": forms.TextInput(
                attrs={"placeholder": "رقم الهاتف", "class": "form-control"}
            ),
            "specialization": forms.TextInput(
                attrs={"placeholder": "التخصص", "class": "form-control"}
            ),
...
class ModificationReportForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "description": forms.Textarea(
                attrs={"rows": 4, "placeholder": "وصف التعديل المطلوب..."}
            ),
        }
...
class ReceiptMemoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "notes": forms.Textarea(
                attrs={"rows": 3, "placeholder": "ملاحظات إضافية..."}
            ),
        }
...
class InstallationFilterForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        active_teams = InstallationTeam.objects.filter(
            is_active=True, installationschedule__isnull=False
        ).distinct()
...
class InstallationAnalyticsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "completed_installations": forms.NumberInput(
                attrs={"class": "form-control"}
            ),
            "pending_installations": forms.NumberInput(attrs={"class": "form-control"}),
            "in_progress_installations": forms.NumberInput(
                attrs={"class": "form-control"}
            ),
...
class ModificationErrorAnalysisForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "error_description": forms.Textarea(
                attrs={"rows": 4, "class": "form-control"}
            ),
            "root_cause": forms.Textarea(attrs={"rows": 3, "class": "form-control"}),
            "solution_applied": forms.Textarea(
                attrs={"rows": 3, "class": "form-control"}
            ),
            "prevention_measures": forms.Textarea(
                attrs={"rows": 3, "class": "form-control"}
            ),
    ...
    class Meta:
        ...
        widgets = {
            "technician_name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "اسم الفني"}
            ),
            "driver_name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "اسم السائق"}
            ),
            ...
            "customer_phone": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "رقم هاتف العميل"}
            ),
            ...
            "salesperson_name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "اسم البائع"}
            ),
            "branch_name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "اسم الفرع"}
            ),
...
class ScheduleEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "location_type": forms.Select(
                attrs={"class": "form-control", "placeholder": "اختر نوع المكان"}
            ),
            "notes": forms.Textarea(
                attrs={
                    "class": "form-control",
...
class DailyScheduleForm(forms.Form):
    ...
    date = forms.DateField(
        ...
        widget=forms.DateInput(
            attrs={"class": "form-control", "type": "date", "id": "date-filter"}
        ),
        initial=timezone.now().date(),
    )
    ...
    status = forms.ChoiceField(
        ...
        widget=forms.Select(attrs={"class": "form-control", "id": "status-filter"}),
        required=False,
    )
    ...
    team = forms.ModelChoiceField(
        label="الفريق",
        queryset=InstallationTeam.objects.filter(is_active=True),
        widget=forms.Select(attrs={"class": "form-control", "id": "team-filter"}),
        required=False,
    ...
    salesperson = forms.ModelChoiceField(
        ...
        queryset=Salesperson.objects.filter(is_active=True),
        widget=forms.Select(
            attrs={"class": "form-control", "id": "salesperson-filter"}
        ),
        required=False,
    ...
    branch = forms.ModelChoiceField(
        label="الفرع",
        queryset=Branch.objects.filter(is_active=True),
        widget=forms.Select(attrs={"class": "form-control", "id": "branch-filter"}),
        required=False,
