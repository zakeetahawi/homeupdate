...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        fabric_products = [
            {"name": "قماش قطن", "code": "FAB001", "unit": "meter", "price": 50},
            {"name": "قماش حرير", "code": "FAB002", "unit": "meter", "price": 75},
        ]
        ...
        try:
            ...
            self.stdout.write(
                self.style.ERROR(f"Error with accessory category: {str(e)}")
            )
        ...
        accessory_products = [
            {"name": "زراير", "code": "ACC001", "unit": "piece", "price": 2},
            {"name": "خيط", "code": "ACC002", "unit": "piece", "price": 1},
        ]
