    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": _("اسم المنتج الأساسي")}
            ),
    ...
    class Meta:
        ...
        widgets = {
            ...
            "barcode": forms.TextInput(
                attrs={"class": "form-control", "placeholder": _("الباركود (اختياري)")}
            ),
...
class ColorAttributeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": _("اسم اللون")}
            ),
            "code": forms.TextInput(
                attrs={
                    "class": "form-control",
...
class BulkPriceUpdateForm(forms.Form):
    ...
    variant_ids = forms.CharField(
        required=False, widget=forms.HiddenInput(attrs={"id": "variant-ids"})
    )
...
class QuickVariantCreateForm(forms.Form):
    ...
    initial_stock = forms.DecimalField(
        ...
        min_value=0,
        widget=forms.NumberInput(
            attrs={"class": "form-control", "step": "1", "min": "0", "placeholder": "0"}
        ),
    )
