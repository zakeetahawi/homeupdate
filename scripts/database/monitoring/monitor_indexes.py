...
class IndexMonitor:
    ...
    def generate_recommendations(
        self, unused_indexes: List[Dict], index_stats: List[Dict]
    ) -> List[str]:
        ...
        if unused_indexes:
            ...
            largest_unused = sorted(
                unused_indexes, key=lambda x: x["size_bytes"], reverse=True
            )[:5]
    ...
    def generate_monitoring_report(
        self, output_file: str = "indexes_monitoring_report.json"
    ):
        ...
        try:
            ...
            report = {
                ...
                "summary": {
                    ...
                    "usage_efficiency": round(
                        (total_indexes - total_unused) / max(total_indexes, 1) * 100, 2
                    ),
                },
    ...
    def _print_summary(self, report: Dict):
        ...
        if report["unused_indexes"]:
            ...
            for idx in sorted(
                report["unused_indexes"], key=lambda x: x["size_bytes"], reverse=True
            )[:5]:
