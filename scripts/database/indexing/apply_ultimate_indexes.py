...
class UltimateIndexManager:
    ...
    def apply_index(self, statement: str, existing_indexes: Dict[str, bool]) -> Tuple[bool, str]:
        """تطبيق فهرس واحد"""
        try:
            # استخراج اسم الفهرس
            ...
            logger.info(f"✅ تم إنشاء الفهرس بنجاح: {index_name} ({duration:.2f} ثانية)")
    ...
    def generate_report(self, output_file: str = "indexing_report.json"):
        ...
        try:
            ...
            report = {
                ...
                'success_rate': (self.stats['successful_indexes'] / max(self.stats['total_indexes'], 1)) * 100
            }
