...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS('✅ تم إعداد صلاحيات نظام الشكاوى بنجاح')
        )
    ...
    def assign_permissions_to_groups(self):
        ...
        admin_permissions = Permission.objects.filter(content_type=complaint_content_type)
    ...
    def assign_users(self):
        ...
        for user in admin_users:
            user.groups.add(supervisors_group, managers_group, complaints_managers_group)
            ...
            permissions.save()
            self.stdout.write(f'  ✅ تم إضافة {user.username} إلى مجموعات الإدارة وتحديث صلاحياته')
        ...
        for user in superusers:
            user.groups.add(supervisors_group, managers_group, complaints_managers_group)
            self.stdout.write(f'  ✅ تم إضافة المدير {user.username} إلى جميع المجموعات')
    ...
    def show_statistics(self):
        ...
        # إحصائيات الصلاحيات
        total_permissions = ComplaintUserPermissions.objects.filter(is_active=True).count()
