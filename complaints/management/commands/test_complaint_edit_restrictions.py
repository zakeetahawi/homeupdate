...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--test-restrictions", action="store_true", help="اختبار قيود التعديل"
        )
    ...
    def create_test_data(self):
        ...
        customer, created = Customer.objects.get_or_create(
            name="عميل اختبار",
            defaults={"phone": "123456789", "email": "customer@test.com"},
        )

        # إنشاء نوع شكوى
        complaint_type, created = ComplaintType.objects.get_or_create(
            name="اختبار",
            defaults={"description": "نوع شكوى للاختبار", "default_deadline_hours": 24},
        )
        ...
        for status in statuses:
            ...
            if created:
                self.stdout.write(
                    f"✅ تم إنشاء شكوى: {complaint.complaint_number} - {status}"
                )
