...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS("🧹 بدء تنظيف الإشعارات القديمة..."))
        ...
        if cleaned_count > 0:
            ...
            self.stdout.write(self.style.SUCCESS("✅ لا توجد إشعارات قديمة للتنظيف"))

        self.stdout.write(self.style.SUCCESS("🎉 اكتمل تنظيف الإشعارات!"))
