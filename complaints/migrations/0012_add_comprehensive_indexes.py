...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="complaint",
            index=models.Index(
                fields=["assigned_department"], name="complaint_dept_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="complaint",
        ...
        migrations.AddIndex(
            model_name="complaint",
            index=models.Index(
                fields=["branch", "status", "created_at"], name="complaint_br_sts_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="complaint",
        ...
        migrations.AddIndex(
            model_name="complaint",
            index=models.Index(
                fields=["related_order", "status"], name="complaint_ord_sts_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="complainttype",
            index=models.Index(
                fields=["responsible_department"], name="comptype_dept_idx"
            ),
        ),
    ]
