...
from ..models import (
    ...
    ComplaintNotification, Department
)
...
class ComplaintsSystemIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.complaint_type = ComplaintType.objects.create(
            name='شكوى فنية',
            description='شكاوى متعلقة بالمسائل الفنية'
        )
    ...
    def test_notification_service_integration(self):
        ...
        with patch('complaints.services.notification_service.send_mail') as mock_send_mail:
    ...
    def test_status_update_api(self):
        ...
        url = reverse('complaints:api_status_update', kwargs={'complaint_id': self.complaint.id})
    ...
    def test_assignment_update_api(self):
        ...
        url = reverse('complaints:api_assignment_update', kwargs={'complaint_id': self.complaint.id})
    ...
    def test_template_tags_functionality(self):
        ...
        from ..templatetags.complaints_tags import (
            complaint_status_badge, complaint_priority_badge,
