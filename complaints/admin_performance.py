...
def optimize_complaint_admin():
    ...
    from .admin import ComplaintAdmin, ComplaintAttachmentInline, ComplaintUpdateInline
    ...
    class OptimizedComplaintAttachmentInline(
        OptimizedInlineMixin, ComplaintAttachmentInline
    ):
...
def get_user_complaint_permissions(user):
    ...
    if permissions is None:
        ...
        cache.set(
            cache_key, permissions, ADMIN_CACHE_SETTINGS["user_permissions_timeout"]
        )
