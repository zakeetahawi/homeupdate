...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"🚀 بدء إنشاء بيانات تجريبية لـ {users_count} مستخدمين لمدة {days} أيام"
            )
        )
        ...
        for day in range(days):
            ...
            for user in users:
                ...
                logout_time = login_time + timedelta(
                    hours=random.randint(4, 8), minutes=random.randint(0, 59)
                )
                ...
                login_history = UserLoginHistory.objects.create(
                    ...
                    operating_system=random.choice(
                        ["Windows 10", "macOS", "Ubuntu", "iOS", "Android"]
                    ),
                ...
                for activity_num in range(
                    random.randint(activities_per_day // 2, activities_per_day)
                ):
        ...
        for i in range(online_users_count):
            ...
            OnlineUser.objects.update_or_create(
                ...
                defaults={
                    ...
                    - timedelta(minutes=random.randint(0, 4)),
