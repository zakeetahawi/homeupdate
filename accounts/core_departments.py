...
def create_core_departments():
    ...
    for dept_data in CORE_DEPARTMENTS:
        ...
        if dept:  # التأكد من أن القسم الرئيسي موجود
            for child_data in children:
                ...
                existing_child = Department.objects.filter(
    ...
    print(
        f"✅ تم التأكد من وجود {len(core_dept_codes)} قسم أساسي و {len(core_child_codes)} قسم فرعي أساسي"
    )
