...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        help_text="كود QR Master الفريد - لا يُعدّل يدوياً",
                        max_length=100,
                        unique=True,
                        verbose_name="كود QR Master",
                    ),
                ),
                (
                    "version",
                    models.IntegerField(
                        help_text="رقم الإصدار (v1, v2, v3...) - يزيد تلقائياً",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="هل QR Master نشط؟ يمكن إلغاؤه عند الشك في تسريبه",
                        verbose_name="نشط",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="عدد الأجهزة المسجلة بهذا QR",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="سبب التجديد أو ملاحظات أخرى",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["code", "is_active"], name="accounts_ma_code_43c0ed_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="masterqrcode",
            index=models.Index(
                fields=["-created_at"], name="accounts_ma_created_2fce03_idx"
            ),
        ),
        ...
        migrations.AddField(
            ...
            field=models.UUIDField(
                ...
                default=uuid.uuid4,
                editable=False,
                help_text="معرف فريد دائم للجهاز - يُستخدم للمصادقة",
                unique=True,
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(
                blank=True,
                help_text="رقم إصدار QR Master المستخدم لتسجيل هذا الجهاز",
                null=True,
                verbose_name="رقم إصدار QR المستخدم للتسجيل",
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                db_index=True,
                help_text="بصمة المتصفح - قد تتغير مع التحديثات",
                max_length=64,
                null=True,
