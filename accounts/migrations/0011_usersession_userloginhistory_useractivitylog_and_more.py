    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_sessions', to=settings.AUTH_USER_MODEL, verbose_name='المستخدم')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action_type', models.CharField(choices=[('login', '🔐 تسجيل دخول'), ('logout', '🚪 تسجيل خروج'), ('login_failed', '❌ فشل تسجيل دخول'), ('page_view', '👁️ عرض صفحة'), ('dashboard_view', '📊 عرض لوحة التحكم'), ('create', '➕ إنشاء'), ('read', '👁️ قراءة'), ('update', '✏️ تحديث'), ('delete', '🗑️ حذف'), ('search', '🔍 بحث'), ('export', '📤 تصدير'), ('import', '📥 استيراد'), ('print', '🖨️ طباعة'), ('download', '⬇️ تحميل'), ('upload', '⬆️ رفع'), ('backup', '💾 نسخ احتياطي'), ('restore', '🔄 استعادة'), ('sync', '🔄 مزامنة'), ('other', '📝 أخرى')], max_length=20, verbose_name='نوع العملية')),
                ('entity_type', models.CharField(choices=[('customer', 'عميل'), ('order', 'طلب'), ('product', 'منتج'), ('inspection', 'معاينة'), ('manufacturing', 'تصنيع'), ('installation', 'تركيب'), ('inventory', 'مخزون'), ('report', 'تقرير'), ('user', 'مستخدم'), ('system', 'نظام'), ('page', 'صفحة'), ('other', 'أخرى')], default='other', max_length=20, verbose_name='نوع الكائن')),
                ...
                ('session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='activities', to='accounts.usersession', verbose_name='الجلسة')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', '-last_activity'], name='accounts_us_user_id_018f2c_idx'),
        ),
        migrations.AddIndex(
            model_name='usersession',
        ...
        migrations.AddIndex(
            model_name='usersession',
            index=models.Index(fields=['login_time'], name='accounts_us_login_t_af2958_idx'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='userloginhistory',
            index=models.Index(fields=['is_successful_login'], name='accounts_us_is_succ_37f1fa_idx'),
        ),
        migrations.AddIndex(
            model_name='useractivitylog',
            index=models.Index(fields=['user', '-timestamp'], name='accounts_us_user_id_39428d_idx'),
        ),
        migrations.AddIndex(
            model_name='useractivitylog',
            index=models.Index(fields=['action_type'], name='accounts_us_action__52beb1_idx'),
        ),
        migrations.AddIndex(
            model_name='useractivitylog',
            index=models.Index(fields=['entity_type'], name='accounts_us_entity__2e5627_idx'),
        ),
        migrations.AddIndex(
            model_name='useractivitylog',
        ...
        migrations.AddIndex(
            model_name='useractivitylog',
            index=models.Index(fields=['success'], name='accounts_us_success_dfcf7b_idx'),
        ),
        migrations.AddIndex(
            model_name='useractivitylog',
            index=models.Index(fields=['ip_address'], name='accounts_us_ip_addr_8ca938_idx'),
        ),
        migrations.AddIndex(
            model_name='onlineuser',
            index=models.Index(fields=['-last_seen'], name='accounts_on_last_se_46eb81_idx'),
        ),
        migrations.AddIndex(
            model_name='onlineuser',
            index=models.Index(fields=['session_key'], name='accounts_on_session_5a9b20_idx'),
        ),
        migrations.AddIndex(
            model_name='onlineuser',
