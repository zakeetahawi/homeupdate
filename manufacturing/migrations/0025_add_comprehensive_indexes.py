...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["manufacturing_order"], name="mfg_item_order_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="manufacturingorderitem",
        ...
        migrations.AddIndex(
            model_name="manufacturingorderitem",
            index=models.Index(
                fields=["manufacturing_order", "fabric_received"],
        ...
        migrations.AddIndex(
            model_name="manufacturingorderitem",
            index=models.Index(
                fields=["manufacturing_order", "status"], name="mfg_item_ord_sts_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="manufacturingorderitem",
            index=models.Index(
                fields=["fabric_received_by"], name="mfg_item_rcvd_by_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="manufacturingorderitem",
        ...
        migrations.AddIndex(
            model_name="manufacturingorder",
            index=models.Index(
                fields=["exit_permit_number"], name="mfg_exit_permit_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="manufacturingorder",
            index=models.Index(
                fields=["delivery_permit_number"], name="mfg_dlv_permit_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="manufacturingorder",
        ...
        migrations.AddIndex(
            model_name="manufacturingorder",
            index=models.Index(
                fields=["expected_delivery_date", "status"], name="mfg_exp_dlv_sts_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="manufacturingorder",
            index=models.Index(
                fields=["production_line", "status", "created_at"],
        ...
        migrations.AddIndex(
            model_name="manufacturingorder",
            index=models.Index(
                fields=["order_type", "status", "order_date"],
