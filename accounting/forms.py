...
from .models import (
    ...
    CustomerAdvance, AccountingSettings
)
...
class AccountForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            'description', 'branch', 'is_active', 'opening_balance'
        ]
        widgets = {
...
class AdvanceUsageForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.advance:
            ...
            self.fields['amount'].widget.attrs['max'] = str(self.advance.remaining_amount)
...
class AccountingSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'fiscal_year_start', 'default_cash_account', 'default_bank_account',
            'default_receivables_account', 'default_revenue_account',
            'default_advances_account',
            'auto_post_transactions', 'require_transaction_approval'
        ]
        widgets = {
            ...
            'default_receivables_account': forms.Select(attrs={
                'class': 'form-control select2'
            }),
            'default_revenue_account': forms.Select(attrs={
                'class': 'form-control select2'
            }),
            'default_advances_account': forms.Select(attrs={
                'class': 'form-control select2'
            }),
            'auto_post_transactions': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
            'require_transaction_approval': forms.CheckboxInput(attrs={
                'class': 'form-check-input'
            }),
        }
