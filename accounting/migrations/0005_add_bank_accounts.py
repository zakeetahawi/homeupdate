...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bank_name",
                    models.CharField(
                        db_index=True, max_length=200, verbose_name="اسم البنك"
                    ),
                ),
                (
                    "bank_name_en",
                    models.CharField(
                        max_length=200, verbose_name="اسم البنك بالإنجليزية"
                    ),
                ),
                (
                    "bank_logo",
                    models.ImageField(
                        ...
                        verbose_name="شعار البنك",
                    ),
                ),
                (
                    "account_number",
                    models.CharField(max_length=100, verbose_name="رقم الحساب"),
                ),
                (
                    "iban",
                    models.CharField(
                ...
                (
                    "branch",
                    models.CharField(blank=True, max_length=200, verbose_name="الفرع"),
                ),
                (
                    "branch_en",
                    models.CharField(
                        blank=True, max_length=200, verbose_name="Branch Name"
                    ),
                ),
                (
                    "account_holder",
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Cached QR code image",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="الحساب الافتراضي للتحصيل",
                ...
                (
                    ...
                    models.IntegerField(
                        default=0,
                        help_text="ترتيب عرض الحساب في القوائم",
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="عرض في صفحة جميع الحسابات",
                        verbose_name="عرض في QR",
                    ),
                ),
                (
                    "cloudflare_synced",
        ...
        migrations.AddIndex(
            model_name="bankaccount",
            index=models.Index(
                fields=["is_active", "display_order"], name="accounting_b_is_acti_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="bankaccount",
