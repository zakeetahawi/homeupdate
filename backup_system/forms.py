...
class BackupForm(forms.Form):
    ...
    name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "أدخل اسم النسخة الاحتياطية"}
        ),
    )
...
class RestoreForm(forms.Form):
    ...
    name = forms.CharField(
        ...
        max_length=200,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "أدخل اسم عملية الاستعادة"}
        ),
    )
...
class UploadBackupForm(forms.Form):
    ...
    backup_file = forms.FileField(
        ...
        widget=forms.FileInput(attrs={"class": "form-control", "accept": ".json,.gz"}),
    )
...
class BackupScheduleForm(forms.Form):
    ...
    name = forms.CharField(
        ...
        max_length=200,
        widget=forms.TextInput(
            attrs={"class": "form-control", "placeholder": "أدخل اسم الجدولة"}
        ),
    )
