...
class BackupJob(models.Model):
    ...
    backup_type = models.CharField('نوع النسخة', max_length=20, choices=TYPE_CHOICES, default='full')
    ...
    def update_progress(self, percentage, step=None, processed_records=None):
        ...
        self.save(update_fields=['progress_percentage', 'current_step', 'processed_records'])
...
class RestoreJob(models.Model):
    ...
    def update_progress(self, percentage, step=None, processed=None, success=None, failed=None):
        """تحديث تقدم المهمة"""
        self.progress_percentage = min(100.0, max(0.0, percentage))
        if step:
            self.current_step = step
        ...
        self.save(update_fields=[
            'progress_percentage', 'current_step', 'processed_records',
...
class BackupSchedule(models.Model):
    ...
    backup_type = models.CharField('نوع النسخة', max_length=20, 
                                 choices=BackupJob.TYPE_CHOICES, default='full')
