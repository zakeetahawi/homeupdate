...
class DatabaseMonitor:
        ...
        try:
            ...
            with conn.cursor() as cursor:
                ...
                with self._lock:
                    ...
                    if current_stats['total_connections'] > self.stats['max_connections_seen']:
                        self.stats['max_connections_seen'] = current_stats['total_connections']
    ...
    def check_alerts(self, stats):
        ...
        if alert_level:
            ...
            logger.warning(f"Database connection alert: {alert_level} - {total} connections")
    ...
    def cleanup_connections(self, force=False):
        ...
        try:
            ...
            direct_config = getattr(settings, 'DATABASES_DIRECT', {}).get('default', db_config)
            ...
            try:
                ...
                if db_stats:
                    ...
                    if alert_level in ['critical', 'emergency']:
                        cleaned = self.db_monitor.cleanup_connections(force=(alert_level == 'emergency'))
                        logger.info(f"Auto-cleanup triggered: {cleaned} connections cleaned")
