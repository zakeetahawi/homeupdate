...
def restart_celery_workers():
    ...
    try:
        ...
        return {"status": "success", "message": "تم إرسال أمر إعادة تشغيل العمال"}

    except Exception as e:
        return {"status": "error", "message": f"خطأ في إعادة تشغيل العمال: {str(e)}"}
...
def cleanup_expired_tasks():
    ...
    try:
        ...
        return {"status": "success", "message": "تم تنظيف المهام المنتهية الصلاحية"}

    except Exception as e:
        return {"status": "error", "message": f"خطأ في تنظيف المهام: {str(e)}"}
