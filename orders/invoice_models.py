...
class InvoiceTemplate(models.Model):
    ...
    show_company_logo = models.BooleanField(
        default=True, verbose_name="إظهار شعار الشركة"
    )
    ...
    header_text = models.TextField(
        blank=True, verbose_name="نص الرأس", help_text="نص يظهر في أعلى الفاتورة"
    )
    footer_text = models.TextField(
        blank=True, verbose_name="نص التذييل", help_text="نص يظهر في أسفل الفاتورة"
    )
