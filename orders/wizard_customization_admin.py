...
class WizardFieldOptionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('المعلومات الأساسية', {
            'fields': ('field_type', 'value', 'display_name')
        }),
        ('الإعدادات', {
            'fields': ('sequence', 'is_active', 'is_default')
        }),
...
class WizardStepConfigurationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('الوصف والمساعدة', {
            'fields': ('step_description', 'help_text')
        }),
        ('الإعدادات', {
...
class WizardGlobalSettingsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('📄 إعدادات العقد', {
            'fields': (
                ('require_contract_for_installation', 'require_contract_for_tailoring'),
                ('require_contract_for_accessory', 'require_contract_for_inspection'),
        ...
        ('🔍 إعدادات المعاينة', {
            'fields': (
                ('require_inspection_for_installation', 'require_inspection_for_tailoring'),
                ('require_inspection_for_accessory', 'require_inspection_for_inspection'),
    ...
    class Media:
        css = {
            'all': ('admin/css/wizard_customization.css',)
        }
