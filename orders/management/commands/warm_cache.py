...
from orders.cache_utils import clear_all_form_cache, get_cache_stats, warm_up_cache
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS("🔥 بدء عملية إدارة التخزين المؤقت..."))
        ...
        if options["clear"] or options["clear_only"]:
            ...
            self.stdout.write(self.style.SUCCESS("✅ تم تنظيف التخزين المؤقت بنجاح"))
        ...
        try:
            warm_up_cache()
            self.stdout.write(self.style.SUCCESS("✅ تم تسخين التخزين المؤقت بنجاح"))
        ...
        self.stdout.write(self.style.SUCCESS("🎉 انتهت عملية إدارة التخزين المؤقت"))
    ...
    def show_cache_stats(self, when):
        ...
        if stats["type"] == "Redis":
            ...
            self.stdout.write(f"النوع: {stats['type']}")
            self.stdout.write(
                f"الرسالة: {stats.get('message', 'لا توجد معلومات إضافية')}"
            )
