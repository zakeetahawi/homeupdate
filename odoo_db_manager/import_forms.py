...
class GoogleSheetsImportForm(forms.Form):
    ...
    sheet_name = forms.ChoiceField(
        label=_("اختر الصفحة"),
        choices=[],
        widget=forms.Select(attrs={"class": "form-select", "id": "sheet_name_select"}),
    ...
    start_row = forms.IntegerField(
        ...
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "2", "id": "start_row_input"}
        ),
    ...
    end_row = forms.IntegerField(
        ...
        required=False,
        widget=forms.NumberInput(
            attrs={"class": "form-control", "placeholder": "100", "id": "end_row_input"}
        ),
    ...
    clear_existing = forms.BooleanField(
        ...
        required=False,
        widget=forms.CheckboxInput(
            attrs={"class": "form-check-input", "id": "clear_existing_checkbox"}
        ),
        help_text=_(
    ...
    def clean(self):
        ...
        if spreadsheet_url and not spreadsheet_id:
            ...
            if match:
                ...
                raise forms.ValidationError(_("رابط جدول البيانات غير صحيح"))
