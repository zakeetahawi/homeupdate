    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاريخ الإنشاء')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='تاريخ التحديث')),
                ('database', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='odoo_db_manager.database', verbose_name='قاعدة البيانات')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contracts_folder_id', models.CharField(blank=True, help_text='معرف المجلد في Google Drive لحفظ ملفات العقود', max_length=255, verbose_name='معرف مجلد العقود')),
                ('contracts_folder_name', models.CharField(blank=True, default='العقود - Contracts', help_text='اسم المجلد في Google Drive للعقود', max_length=255, verbose_name='اسم مجلد العقود')),
