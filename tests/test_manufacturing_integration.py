...
class ManufacturingIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.customer = Customer.objects.create(
            name="عميل اختباري", phone="+966501234567", email="test@example.com"
        )
    ...
    def test_manufacturing_order_ui(self):
        ...
        detail_url = reverse(
            "manufacturing:order_detail", args=[manufacturing_order.id]
        )
    ...
    def test_manufacturing_order_status_update_api(self):
        ...
        update_url = reverse(
            "manufacturing:api_update_order_status", args=[manufacturing_order.id]
        )
        response = self.client.post(
            update_url, {"status": "in_progress"}, content_type="application/json"
        )
